		...
		questions: [
			{
				...
				keywords: ["about", "what is", "platform", "learning", "revision", "explain", "overview"],
			},
			{
				id: "gs-2",
				...
				keywords: ["free", "cost", "price", "pricing", "payment", "charge", "money", "pay"],
			},
			{
				id: "gs-3",
				...
				keywords: ["subjects", "gcse", "a-level", "alevel", "maths", "biology", "chemistry", "physics", "english", "topics", "courses", "curriculum"],
			},
			{
				id: "gs-4",
				...
				keywords: ["exam board", "aqa", "edexcel", "ocr", "course", "specification", "spec", "syllabus", "board"],
			},
			{
				id: "gs-5",
				...
				keywords: ["exam board", "dont know", "unsure", "which board", "find out", "change board"],
			},
			{
				id: "gs-6",
				...
				keywords: ["study tools", "videos", "flashcards", "quizzes", "practice", "how to use", "questions", "learn", "revision tools"],
			},
		],
	},
	{
		...
		questions: [
			{
				...
				keywords: ["account", "sign up", "signup", "register", "registration", "create account", "log in", "login"],
			},
			{
				id: "ac-2",
				...
				keywords: ["password", "forgot", "reset password", "recover", "cant login", "locked out", "forgotten", "lost password"],
			},
			{
				id: "ac-3",
				...
				keywords: ["reset", "progress", "start over", "clear", "restart", "redo", "wipe"],
			},
			{
				id: "ac-4",
				...
				keywords: ["share", "sharing", "multiple users", "same account", "family", "siblings", "brother", "sister"],
			},
			{
				id: "ac-5",
				question: "Can I use Cognito on my phone?",
				...
				keywords: ["mobile", "phone", "tablet", "ipad", "android", "iphone", "app", "device", "responsive"],
			},
		],
	},
	{
		...
		questions: [
			{
				...
				keywords: ["teacher", "class", "classroom", "teaching", "homework", "assignments", "school use"],
			},
			{
				id: "tc-2",
				...
				keywords: ["teacher account", "wrong account", "student account", "convert", "switch account type", "account type"],
			},
			{
				id: "tc-3",
				...
				keywords: ["school", "bulk", "licence", "license", "school-wide", "institution", "site licence", "whole school"],
			},
			{
				id: "tc-4",
				...
				keywords: ["teacher features", "analytics", "track progress", "assignments", "playlists", "class management", "dashboard"],
			},
		],
	},
	{
		...
		questions: [
			{
				...
				keywords: ["cancel", "cancle", "cancellation", "stop", "end subscription", "unsubscribe", "quit"],
			},
			{
				id: "bl-2",
				...
				keywords: ["change plan", "upgrade", "downgrade", "switch plan", "modify subscription"],
			},
			{
				id: "bl-3",
				...
				keywords: ["auto-renew", "automatic renewal", "stop renewing", "turn off renewal", "recurring", "auto renewal"],
			},
			{
				id: "bl-4",
				...
				keywords: ["pause", "freeze", "hold", "temporary stop", "break", "suspend"],
			},
			{
				id: "bl-5",
				...
				keywords: ["per subject", "individual subject", "one subject", "single subject", "pay for one"],
			},
			{
				id: "bl-6",
				...
				keywords: ["discount", "bundle", "deal", "offer", "cheaper", "savings", "coupon", "promo", "voucher"],
			},
			{
				id: "bl-7",
				...
				keywords: ["refund", "money back", "return", "refund policy", "get my money back", "reimbursement"],
			},
			{
				id: "bl-8",
				...
				keywords: ["monthly to annual", "yearly", "annual plan", "switch billing", "change billing cycle"],
			},
		],
	},
];
