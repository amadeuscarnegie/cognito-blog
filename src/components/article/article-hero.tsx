...
export function ArticleHero({ article }: ArticleHeroProps) {
	...
	return (
		<div className="flex flex-col gap-5 lg:gap-10 mb-8 lg:mb-12">
			{/* Theme badge */}
			{themeName && (
				<span className="inline-flex self-start bg-[#d1eafd] text-border-brand text-xs font-body font-bold px-2.5 py-1 rounded-full">
					{themeName}
				</span>
			)}

			{/* Title */}
			<h1 className="font-heading text-[28px] lg:text-[40px] leading-[1.15] tracking-[-0.01em] font-bold text-text-primary">
				{article.title}
			</h1>

			{/* Excerpt */}
			<p className="font-body font-medium text-[17px] lg:text-lg leading-[1.8] text-text-primary">
				{article.excerpt}
			</p>
			...
			<div className="flex items-center justify-between">
				<div className="flex items-center gap-3">
					...
					{article.author.avatarUrl && (
						<div className="relative w-10 h-10 rounded-full border border-border-primary overflow-hidden flex-shrink-0">
							<Image
